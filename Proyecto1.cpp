...
int main()
{
    ...
    abarrote* producto4 = new abarrote("004", "Producto 4", "Producto abarrote", "abarrote", "Empresa abarrotes", 1000, 200, 10, true, 1000, new fecha(1, 1, 24), new fecha(1,1,24));
    listaProductos.agregarElemento(producto1);
    listaProductos.agregarElemento(producto2);
    listaProductos.agregarElemento(producto3);
    listaProductos.agregarElemento(producto4);
